import { FaFilePdf, FaVideo, FaBook, FaPhoneAlt, FaMapMarkerAlt, FaDownload, FaPlay, FaExternalLinkAlt } from 'react-icons/fa';
  ...
  const educationalVideos = [
    {
      ...
      icon: <FaVideo />,
      link: "#",
      thumbnail: "https://images.unsplash.com/photo-1579684385127-1ef15d508118?ixlib=rb-1.2.1&auto=format&fit=crop&q=80"
    },
    {
      ...
      icon: <FaVideo />,
      link: "#",
      thumbnail: "https://images.unsplash.com/photo-1584515933487-779824d29309?ixlib=rb-1.2.1&auto=format&fit=crop&q=80"
    },
    {
      ...
      icon: <FaVideo />,
      link: "#",
      thumbnail: "https://images.unsplash.com/photo-1559757175-0eb30cd8c063?ixlib=rb-1.2.1&auto=format&fit=crop&q=80"
    }
  ];

  const helplineNumbers = [
    { name: "Medical Emergency", number: "108", icon: <FaPhoneAlt className="text-red-600" /> },
    { name: "COVID-19 Helpline", number: "1075", icon: <FaPhoneAlt className="text-blue-600" /> },
    { name: "Mental Health Helpline", number: "1800-599-0019", icon: <FaPhoneAlt className="text-green-600" /> },
    { name: "Women's Helpline", number: "1091", icon: <FaPhoneAlt className="text-purple-600" /> }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <div className="relative py-20 bg-blue-600">
        ...
        <div className="relative container mx-auto px-4 text-center">
          <h1 className="text-5xl font-bold text-white mb-6">Health Resources</h1>
          <p className="text-xl text-blue-100 max-w-2xl mx-auto">
            Access valuable healthcare information and educational materials
          </p>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="mb-16">
          <h2 className="text-3xl font-bold mb-8">Health Guides</h2>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8">
          <h2 className="text-3xl font-bold mb-8">Emergency Helpline Numbers</h2>
