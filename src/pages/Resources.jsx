  ...
  const healthGuides = [
    {
      ...
      type: "PDF",
      icon: <FaFilePdf className="text-blue-600 dark:text-blue-400" />,
      link: "#",
      image:
  ...
  const educationalVideos = [
    {
      ...
      duration: "10 mins",
      icon: <FaVideo className="text-blue-600 dark:text-blue-400" />,
      link: "#",
      thumbnail:
  ...
  const helplineNumbers = [
    {
      ...
      number: "108",
      icon: <FaPhoneAlt className="text-red-600 dark:text-red-400" />,
    },
    {
      name: "COVID-19 Helpline",
      number: "1075",
      icon: <FaPhoneAlt className="text-blue-600 dark:text-blue-400" />,
    },
    {
      name: "Mental Health Helpline",
      number: "1800-599-0019",
      icon: <FaPhoneAlt className="text-green-600 dark:text-green-400" />,
    },
    {
            ...
            {healthGuides.map((guide, index) => (
              ...
              >
                ...
                <div className="p-6">
                  <a
                    href={guide.link}
                    className="flex items-center justify-center space-x-2 bg-blue-600 text-white py-3 px-6 rounded-xl hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600 transition-colors group-hover:scale-[1.02] transform transition-transform"
                  >
                    <FaDownload />
              ...
              >
                <div className="relative h-48">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="w-16 h-16 bg-white/90 dark:bg-gray-800/90 rounded-full flex items-center justify-center group-hover:scale-110 transition-transform">
                      <FaPlay className="text-blue-600 dark:text-blue-400 text-xl ml-1" />
                    </div>
                  </div>
                  <div className="absolute bottom-4 left-4 text-white">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {helplineNumbers.map((helpline, index) => (
              <div
                key={index}
                className="bg-gray-50 dark:bg-gray-700 rounded-xl p-6 text-center hover:shadow-md transition-shadow transform hover:-translate-y-1"
              >
