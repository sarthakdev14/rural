import { FaAmbulance, FaPhone, FaHospital, FaDirections, FaMapMarkedAlt, FaHeartbeat, FaFirstAid } from 'react-icons/fa';

function Emergency() {
  const emergencyContacts = [
    { name: "Ambulance", number: "108", icon: <FaAmbulance className="text-red-600" /> },
    { name: "Police", number: "100", icon: <FaPhone className="text-blue-600" /> },
    { name: "Fire", number: "101", icon: <FaPhone className="text-orange-600" /> },
    { name: "National Emergency", number: "112", icon: <FaPhone className="text-green-600" /> }
  ];
  ...
  const nearbyHospitals = [
    {
      ...
      phone: "1234567890",
      image: "https://images.unsplash.com/photo-1587351021759-3e566b6af7cc?ixlib=rb-1.2.1&auto=format&fit=crop&q=80"
    },
    {
      ...
      phone: "0987654321",
      image: "https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?ixlib=rb-1.2.1&auto=format&fit=crop&q=80"
    },
    {
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <div className="relative bg-red-600">
        ...
        <div className="relative container mx-auto px-4 py-16 text-center">
          ...
          <h1 className="text-5xl font-bold text-white mb-6">Emergency Services</h1>
          <p className="text-2xl text-red-100 mb-8">24/7 Emergency Response Available</p>
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {emergencyContacts.map((contact, index) => (
              <div key={index} className="bg-white rounded-2xl shadow-lg p-8 text-center transform hover:-translate-y-1 transition-all duration-300">
        ...
        <div className="mb-16 bg-blue-50 rounded-2xl p-8">
          <div className="flex items-center mb-6">
            ...
            <h2 className="text-3xl font-bold">Quick First Aid Tips</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-white p-6 rounded-xl shadow-md">
              <h3 className="text-xl font-bold mb-3">Bleeding</h3>
              <p className="text-gray-600">Apply direct pressure with a clean cloth. Elevate the injured area if possible.</p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-md">
              <h3 className="text-xl font-bold mb-3">Burns</h3>
              <p className="text-gray-600">Cool the burn under cold running water for at least 10 minutes.</p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-md">
              <h3 className="text-xl font-bold mb-3">Choking</h3>
              <p className="text-gray-600">Perform the Heimlich maneuver if the person is conscious.</p>
            </div>
          </div>
        </div>
        ...
        <div id="nearby-hospitals">
          <h2 className="text-3xl font-bold mb-8">Nearby Hospitals</h2>
